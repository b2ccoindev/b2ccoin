B2CCoin Core version 0.13.3 is now available from:

  <https://download.b2ccoin.org/b2ccoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/b2ccoin-project/b2ccoin/blob/0.13/src/chainparams.cpp#L214).
