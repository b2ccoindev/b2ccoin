...
{
    const char* pszTimestamp = "The Coin for B2C World Business";
    const CScript genesisOutputScript = CScript() << ParseHex("04CA24493F9B611B9C5974644B14F0F6E191E00B681C9A6B82866DF9DC5BA1D67D1B6F1DB8F007B8FCE58A8D8052D7DB15CD32ED73C45B1618F0202766C713114B") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("950b56fd91ac1451ed08e34febc32e8393de73bb3d93660e48357a4909a8d674");
        ...
        consensus.defaultAssumeValid = uint256S("0x950b56fd91ac1451ed08e34febc32e8393de73bb3d93660e48357a4909a8d674"); //1441280
        ...
        genesis = CreateGenesisBlock(1590174557, 12733, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x950b56fd91ac1451ed08e34febc32e8393de73bb3d93660e48357a4909a8d674"));
        assert(genesis.hashMerkleRoot == uint256S("0xc870bf105290fc2bc4502d2d75be3a68ffc38668367f7d36bab7db5545a5f7f3"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.b2ccoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.b2ccointools.com");
        //vSeeds.emplace_back("dnsseed.b2ccoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xd674270241fda5f6b862a2bf83d05aa5ba6b5b04a4d711448ff3725598e9a275"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 1490066, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd674270241fda5f6b862a2bf83d05aa5ba6b5b04a4d711448ff3725598e9a275"));
        assert(genesis.hashMerkleRoot == uint256S("0xc870bf105290fc2bc4502d2d75be3a68ffc38668367f7d36bab7db5545a5f7f3"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.b2ccointools.com");
        //vSeeds.emplace_back("seed-b.b2ccoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4c133f627d307fec171e54ac2198c4f0a46795109f0e08ad32fabab011b6c11d"));
        assert(genesis.hashMerkleRoot == uint256S("0xc870bf105290fc2bc4502d2d75be3a68ffc38668367f7d36bab7db5545a5f7f3"));
