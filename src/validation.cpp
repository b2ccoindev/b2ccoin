...
#if defined(NDEBUG)
# error "B2CCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "B2CCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s B2C additional fees, %d delta bytes\n",
...
if (nHeight == 1) return COIN * 250000000;
