...
const char * const BITCOIN_CONF_FILENAME = "b2ccoin.conf";
const char * const BITCOIN_PID_FILENAME = "b2ccoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "B2CCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/B2CCoin";
#else
    // Unix
    return pathRet / ".b2ccoin";
#endif
#endif
}
