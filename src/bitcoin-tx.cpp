...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s b2ccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  b2ccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded b2ccoin transaction") + "\n" +
              "  b2ccoin-tx [options] -create [commands]   " + _("Create hex-encoded b2ccoin transaction") + "\n" +
              "\n";
