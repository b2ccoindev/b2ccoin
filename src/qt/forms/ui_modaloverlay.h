...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(ModalOverlay *ModalOverlay)
    {
        ...
        infoText->setText(QApplication::translate("ModalOverlay", "Recent transactions may not yet be visible, and therefore your wallet's balance might be incorrect. This information will be correct once your wallet has finished synchronizing with the b2ccoin network, as detailed below.", 0));
        infoTextStrong->setText(QApplication::translate("ModalOverlay", "Attempting to spend b2ccoins that are affected by not-yet-displayed transactions will not be accepted by the network.", 0));
