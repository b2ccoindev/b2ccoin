...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        useAvailableBalanceButton = new QPushButton(SendCoins);
        useAvailableBalanceButton->setObjectName(QStringLiteral("useAvailableBalanceButton"));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The B2CCoin address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less b2ccoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setText(QApplication::translate("SendCoinsEntry", "S&ubtract fee from amount", 0));
        useAvailableBalanceButton->setText(QApplication::translate("SendCoinsEntry", "Use available balance", 0));
        messageLabel->setText(QApplication::translate("SendCoinsEntry", "Message:", 0));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the b2ccoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the B2CCoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
