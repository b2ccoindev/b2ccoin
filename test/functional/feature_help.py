...
"""Verify that starting b2ccoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start b2ccoin with -h for help text")
        ...
        self.log.info("Start b2ccoin with -version for version information")
